...
import (
	...
	elasticloadbalancingv2v1alpha1 "github.com/crossplane/provider-aws/apis/elasticloadbalancingv2/v1alpha1"
...
func init() {
	...
	AddToSchemes = append(AddToSchemes,
		...
		elasticloadbalancingv2v1alpha1.SchemeBuilder.AddToScheme,
